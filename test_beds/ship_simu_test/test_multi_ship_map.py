...
tar_ship_heading_controller_gains1 = HeadingControllerGains(kp=1.5, kd=75, ki=0.005)
...
tar_ship_desired_speed1 = 4.5
tar_ship_cross_track_error_tolerance1 = 750
tar_ship_initial_propeller_shaft_speed1 = 0
tar_ship_initial_propeller_shaft_acceleration1 = 0
tar_ship1 = ShipModel(
    ship_config=ship_config,
...
tar_ship_heading_controller_gains2 = HeadingControllerGains(kp=1.5, kd=75, ki=0.005)
...
tar_ship_desired_speed2 =4.5
tar_ship_cross_track_error_tolerance2 = 750
tar_ship_initial_propeller_shaft_speed2 = 0
tar_ship_initial_propeller_shaft_acceleration2 = 0
tar_ship2 = ShipModel(
    ship_config=ship_config,
